...
- [x] Per-state landing pages (`states/`) for long-tail SEO — 54 pages, generated by build.py
- [x] Automated new-PDF detection (weekly GitHub Action → opens an issue)
- [ ] Migrate hosting to Cloudflare Pages + custom domain (repo goes private)
